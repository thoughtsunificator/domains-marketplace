        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <form method="POST" enctype="multipart/form-data">
              ...
              @endif
              <div class="col-xs-12 col-md-6">
                <label>Premium Submission(Optional)</label><br />
                <select name="is_premium" class="form-control">
                  <option {{ $d->is_premium ? 'selected' : '' }} value="1">Yes</option>
                  <option {{ !$d->is_premium ? 'selected' : '' }} value="0">No</option>
                </select>
                <br />
              </div>
              <div class="col-xs-12 col-md-6">
              ...
              <div class="col-xs-12 col-md-12">
                ...
                <input type="text" id="#inputTag" class="form-control" value="{{ $d->keywords }}" name="keywords"
                  data-role="tagsinput">
