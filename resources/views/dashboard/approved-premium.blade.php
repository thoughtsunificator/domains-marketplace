		...
		<div class="row">
			...
			<div class="col-md-9">
				<div class="panel panel-default">
					<div class="panel-heading">Welcome to your premium domain overview (here you see all your premium domain
						submissions
						that have been approved or disapproved) These domains can be edited, viewed and deleted by you.
					</div>
								...
								<tbody class="searchable">
									@foreach ($domains as $d)
										<tr>
											...
											<td>
												<div class="btn-group">
													<a class="btn btn-primary btn-xs" href="/dashboard/premium-manage-domain/{{ $d->domain }}">
